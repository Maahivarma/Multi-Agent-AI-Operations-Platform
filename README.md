...
There are three main issues in your current README code that will prevent it from looking professional or displaying images correctly on GitHub:

Broken Image Paths: Your project structure shows images are inside the screenshots/ folder, but your image links point to the assets/ folder.

Syntax Errors: You have an extra ---md tag in the middle of the text which will show up as raw text.

Unclosed Code Blocks: The "Project Structure" code block is never closed with ```, which will cause the rest of your README to look like a grey code box.

Here is the corrected and optimized code for your README.md:
